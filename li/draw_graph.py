...
class Demo:
    ...
    def drawPie(self, name):
        ...
        return self.drawSingleTimeSpend(singleTimeSpend, name)
    ...
    def drawBarAndLine(self, name):
        ...
        return self.drawSingleFrequencyAndTime(singleFrequencyAndTime, name)
    ...
    def drawMultipleToday(self, name):
        ...
        :return:
        """
        return self.drawMultipleFrequencyOfToday(name)
    ...
    def drawMultipleWeek(self, name):
        ...
        :return:
        """
        return self.drawMultipleFrequencyOfWeek(name)
